---
title: 使用caffe的python接口进行特征提取
date: 2017-03-09 10:46:47
reward: true
categories: "caffe"
tags:
	- caffe
...
<!--more-->
本文主要参考caffe官网的例子：  
[Image Classification and Filter Visualization](http://nbviewer.jupyter.org/github/BVLC/caffe/blob/master/examples/00-classification.ipynb)  
...
此脚本也可在我的github上找到
[caffe-test-script](https://github.com/wujiyang/caffe-test-script)   

我使用VGG-Face模型进行测试时，精确度只有0.96左右，距离论文中的0.98还有些距离。
